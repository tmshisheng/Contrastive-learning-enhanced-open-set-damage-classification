...
model.load_state_dict(torch.load(f'Trained_Models_Without_Augmentation/{nl}/ConvAutoencoder_{window_size}.pth'))
hplossfunc = joblib.load(f'Trained_Models_Without_Augmentation/{nl}/hplossfunc_{window_size}.pth')
